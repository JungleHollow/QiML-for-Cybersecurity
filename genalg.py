...
def fit_func(chromo: cr.Chromo) -> float:
    ...
    save_path = rf"C:\Users\WornA\OneDrive\Desktop\Uni Work\Honours Thesis\Code\models_binary\DQiNN_{save_name}_{dent.N_QUBITS}-qubit_{dent.N_LAYERS}-layer_{dent.DATASET}.keras"
...
if __name__ == '__main__':
    a = GA(8, cr.DatType.INTEGER, 0.0, 1.0, 5, 0.9, 0.1, fit_func)
    ...
    ax.set(xlabel='Iterations', ylabel='Fitness Function',
           title='Average F1 Score Over Iterations (8-Qubit UNSW_NB15)')
    ax.grid()
    # plt.show()
